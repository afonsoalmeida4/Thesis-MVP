...
uint8_t NwkSkey[16] = {0xb9,0x4b,0x0c,0x78,0xba,0x47,0x57,0xed,0xde,0x37,0xdb,0x32,0x67,0x45,0x30,0x69};
// Application Session Key (MSB)
uint8_t AppSkey[16] = {0x49,0x84,0x30,0x62,0xfa,0x86,0x54,0x28,0xff,0xf0,0x07,0x7a,0xdd,0x80,0x55,0x0f};
// Device Address (MSB)
uint8_t DevAddr[4] = {0x01,0xbf,0x0c,0x77} ;

/*// Network Session Key (MSB)
uint8_t NwkSkey[16] = {0xea,0xc8,0x92,0x55,0xa7,0x04,0xef,0x7f,0x0d,0xfe,0xe1,0xa0,0x09,0x4c,0xd6,0x11};

// Application Session Key (MSB)
uint8_t AppSkey[16] = {0x36,0xcd,0x9a,0x20,0x7a,0x73,0x44,0xa9,0x1e,0x1b,0x26,0x89,0x14,0xa5,0x9d,0x2e};

// Device Address (MSB)
uint8_t DevAddr[4] =  {0x00, 0x53, 0x43, 0x66} ;*/
